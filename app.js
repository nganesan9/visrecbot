...
var visualRecognition = new watson.VisualRecognitionV3({
  api_key: '05c0aa40d49bfe7f2a27bed3a4f9bb60d94a7243',
...
/* Getting answers from Poker classifier */
app.get('/getpokerclassifieranswer', function(req, res){
  console.log("Getting results from API call to Poker classifier");
  console.log("See image path from URL : " + req.query.image_path);
  //See current directory
  console.log(__dirname);
  //If image_path has the form /images/sample  etc, then append it to dir name for public URL, else continue with url from web
  var url_for_classification = 'https://gateway-a.watsonplatform.net/visual-recognition/api/v3/classify?api_key=3fdc61f995ea4a4974aef11b3ab91231e8282a7f&url=' + req.query.image_path + '&classifier_ids=high_cards_2057216051&classifier_ids=suits_964863070&version=2016-05-19';
  request({
  			 //url: "https://gateway-a.watsonplatform.net/visual-recognition/api/v3/classify?api_key=3fdc61f995ea4a4974aef11b3ab91231e8282a7f&url=https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Playing_card_spade_8.svg/1000px-Playing_card_spade_8.svg.png&classifier_ids=high_cards_2057216051&classifier_ids=suits_964863070&version=2016-05-19",
             url : url_for_classification,
  			 json: true
  			}, function (error, response, body) {
  		if (!error && response.statusCode === 200)
  		{
  			//Check for response from server
        var class_name = body.images[0].classifiers[0].classes[0].class;
        var score = body.images[0].classifiers[0].classes[0].score;
        var image_path = body.images[0].source_url;
  			var name_string='{\"class_name\":\"' + class_name + '\",\"score\":\"' + score + '\",\"image_path\":\"' + image_path + '\"}';
  		...
  		else
  		{
  			...
  			var name_string='{\"class_name\":\"couldn\'t classify\",\"score\":\"0\",\"image_path\":\"no image\"}';
  			res.contentType('application/json');
  			res.send(JSON.parse(name_string));
  		}
  	});
